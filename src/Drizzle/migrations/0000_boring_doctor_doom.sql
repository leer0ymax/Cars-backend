...
--> statement-breakpoint
ALTER TABLE "booking" ADD CONSTRAINT "booking_CarID_car_CarID_fk" FOREIGN KEY ("CarID") REFERENCES "public"."car"("CarID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "booking" ADD CONSTRAINT "booking_CustomerID_customer_customerID_fk" FOREIGN KEY ("CustomerID") REFERENCES "public"."customer"("customerID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payment" ADD CONSTRAINT "payment_BookingID_booking_BookingID_fk" FOREIGN KEY ("BookingID") REFERENCES "public"."booking"("BookingID") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
